...
TextureLoader.onReady = () => {
    ...
    if (ResourceManager.setLevel("first_level")) {
        update(0)
        t = ResourceManager.currentLevel.sectors.main.things[6]
        barrel = ResourceManager.currentLevel.sectors.internal.things[0]
    }
}
...
function update(time) {
    ...
    //lastTime = time
    const deltaTime = (performance.now() - lastTime) * 0.001
